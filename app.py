...
def criar_sabor():
    ...
    try:
        ...
        return jsonify(
            {"erro": "Preço ou custo inválido"}
        ), 400

    if not nome:
        return jsonify(
            {"erro": "Informe o nome do sabor"}
        ), 400
...
@app.put("/api/sabores/<int:sabor_id>")
        ...
        return jsonify(
            {
                ...
                "faturamento_dia": financeiro[
                    "faturamento"
                ],
                "custo": financeiro[
                    "custo"
                ],
                "custo_dia": financeiro[
                    "custo"
                ],
                "lucro": financeiro[
                    "lucro"
                ],
                "lucro_dia": financeiro[
                    "lucro"
                ],
                "despesas": financeiro[
                    "despesas"
                ],
                "despesas_dia": financeiro[
                    "despesas"
                ],
                "saldo_esperado": financeiro[
                    "saldo_caixa"
                ],
                "saldo_caixa": financeiro[
                    "saldo_caixa"
                ],
                "status_dia": financeiro[
                    "status"
                ],
            }
        )
...
# quando o Gunicorn carregar a aplicação.
init_db()
